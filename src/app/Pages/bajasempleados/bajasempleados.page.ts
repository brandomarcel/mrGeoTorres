...
@Component({
  selector: 'app-bajasempleados',
  templateUrl: './bajasempleados.page.html',
  styleUrls: ['./bajasempleados.page.scss'],
})
export class BajasempleadosPage implements OnInit {
    ...
    this.firestore.ObtenerTecnicos().subscribe((resp: any) => {
      ...
      if (resp[0]) {
        for (let index = 0; index < resp.length; index++) {
          ...
          if (rol.includes('T') || rol.includes('O')) {
            tecnico = new Usuario();
